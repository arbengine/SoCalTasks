...
import { Box, rem, Flex, Text, Inline, useToast, Stack, Card, Layer, BoundaryElementProvider, MenuDivider, Menu, TextSkeleton, rgba, useElementRect, LayerProvider, _raf2, TextInput, Code, TabList, TabPanel, DialogProvider, Heading, Spinner, focusFirstDescendant, Container, usePortal, PortalProvider, Popover, useLayer, useGlobalKeyDown, useClickOutsideEvent, Button as Button$1, Grid as Grid$1, Dialog as Dialog$1, Badge, Checkbox, Select, AvatarStack, Skeleton } from "@sanity/ui";
...
import { defineLocaleResourceBundle, useSchema, useTranslation, unstable_useValuePreview, isRecord, getPreviewStateObservable, getPreviewValueWithFallback, DocumentPreviewPresence, DocumentStatusIndicator, DocumentStatus, SanityDefaultPreview, useUnique, getPublishedId, useDocumentPresence, useDocumentPreviewStore, PreviewCard, Translate, createHookFromObservableFactory, getDraftId, useClient, DEFAULT_STUDIO_CLIENT_OPTIONS, useDocumentStore, LoadingBlock, LegacyLayerProvider, IsLastPaneProvider, useGetI18nText, useI18nText, TooltipOfDisabled, ContextMenuButton, StatusButton, useCurrentUser, InsufficientPermissionsMessage, useTemplates, useTemplatePermissions, EMPTY_ARRAY as EMPTY_ARRAY$2, EMPTY_OBJECT, useEditState, GetHookCollectionState, isDev, CommentsEnabledProvider, useCommentsEnabled, COMMENTS_INSPECTOR_NAME, CommentsProvider, useDocumentOperationEvent, Resizable, useKeyValueStore, isString as isString$1, useDocumentOperation, isDeprecatedSchemaType, useProjectId, useZIndex, useListFormat, isDraftId, FormBuilder, createPatchChannel, PresenceOverlay, fromMutationPatches, ScrollContainer, VirtualizerScrollInstanceProvider, useDocumentPairPermissions, useValidationStatus, useSyncState, useRelativeTime, Hotkeys, useTimelineSelector, useFieldActions, TextWithTone, resizeObserver, useSanityCreateConfig, isSanityCreateLinked, useSource, ChangeConnectorRoot, getSanityCreateLinkMetadata, useGlobalCopyPasteElementHandler, GetFormValueProvider, FieldActionsResolver, FieldActionsProvider, useMiddlewareComponents, useCopyPaste, usePresenceStore, useInitialValue, useConnectionState, setAtPath, useDocumentValuePermissions, isSanityCreateLinkedDocument, toMutationPatches, useFormState, getExpandOperations, useTimelineStore, CopyPasteProvider, SourceProvider, useDocumentType, ReferenceInputOptionsProvider, ErrorActions, CommandList, collate, createSWR, getSearchableTypes, createSearch, useWorkspace, useSearchMaxFieldDepth, useSearchState, SearchHeader, Filters, SearchProvider, getConfigContextFromSource, UserAvatar, useDateTimeFormat, useUser, ChangeFieldWrapper, NoChanges, ChangeList, isArray, isValidationError, isValidationWarning, definePlugin, useConfigContextFromSource } from "sanity";
...
const structureLocaleNamespace = "structure", structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources.esm4.js")
});
    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      /* @__PURE__ */ jsxs(Box, { overflow: "auto", paddingTop: 2, children: [
        /* @__PURE__ */ jsxs(Table$1, { children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$i).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
const PANE_DEBUG = !1, PANE_COLLAPSED_WIDTH = 51, PANE_DEFAULT_MIN_WIDTH = 204, Root$8 = styled(Layer)`
  position: relative;
  width: 1px;
  min-width: 1px;
...
function PaneDivider(t0) {
  ...
  let t4;
  return $[3] !== handleMouseDown || $[4] !== t2 || $[5] !== t3 ? (t4 = /* @__PURE__ */ jsx(Root$8, { "data-disabled": t2, "data-dragging": t3, onMouseDown: handleMouseDown }), $[3] = handleMouseDown, $[4] = t2, $[5] = t3, $[6] = t4) : t4 = $[6], t4;
}
const Root$7 = styled(Card)`
  outline: none;
...
`, Pane = forwardRef(function(props, forwardedRef) {
  ...
  let t25;
  $[66] !== hidden || $[67] !== id || $[68] !== paneIndex || $[69] !== restProps || $[70] !== style || $[71] !== t19 || $[72] !== t20 || $[73] !== t21 || $[74] !== t22 || $[75] !== t24 ? (t25 = /* @__PURE__ */ jsxs(Root$7, { "data-testid": "pane", "data-ui": "Pane", tone: "inherit", hidden, id, overflow: t19, ...restProps, "data-pane-collapsed": t20, "data-pane-index": paneIndex, "data-pane-selected": t21, ref: setRef, style, children: [
    t22,
    t24
...
const PaneContent = forwardRef(function(props, ref) {
  ...
  let t1;
  return $[6] !== as || $[7] !== children || $[8] !== collapsed || $[9] !== padding || $[10] !== ref || $[11] !== restProps || $[12] !== t0 ? (t1 = /* @__PURE__ */ jsx(Root$6, { "data-testid": "pane-content", forwardedAs: as, ...restProps, flex: 1, hidden: collapsed, overflow: t0, padding, ref, tone: "inherit", children }), $[6] = as, $[7] = children, $[8] = collapsed, $[9] = padding, $[10] = ref, $[11] = restProps, $[12] = t0, $[13] = t1) : t1 = $[13], t1;
});
...
`, PaneFooter = forwardRef(function(props, ref) {
  ...
  let t1;
  return $[3] !== collapsed || $[4] !== ref || $[5] !== t0 ? (t1 = /* @__PURE__ */ jsx(LegacyLayerProvider, { zOffset: "paneFooter", children: /* @__PURE__ */ jsx(Root$5, { "data-testid": "pane-footer", hidden: collapsed, ref, children: t0 }) }), $[3] = collapsed, $[4] = ref, $[5] = t0, $[6] = t1) : t1 = $[6], t1;
}), Root$4 = styled(Layer)(({
  $border
}) => css`
    line-height: 0;
...
`, TabsBox = styled(Box)(({
  ...
  let t18;
  return $[41] !== border || $[42] !== ref || $[43] !== t17 || $[44] !== t5 ? (t18 = /* @__PURE__ */ jsx(LayerProvider, { zOffset: 100, children: /* @__PURE__ */ jsx(Root$4, { $border: border, "data-collapsed": t5, "data-testid": "pane-header", ref, children: t17 }) }), $[41] = border, $[42] = ref, $[43] = t17, $[44] = t5, $[45] = t18) : t18 = $[45], t18;
});
...
function PaneLayout(props) {
  ...
  let t14;
  $[32] !== children || $[33] !== restProps || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 ? (t14 = /* @__PURE__ */ jsx(Root$3, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t11, "data-resizing": t12, "data-mounted": t13, ref: setRootElement, children }), $[32] = children, $[33] = restProps, $[34] = t11, $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37];
  let t15;
...
}), isLiveEditEnabled = (schemaType) => schemaType.liveEdit === !0, Root$2 = styled(Card)({
  position: "relative",
  zIndex: 1,
  lineHeight: 0
});
function DocumentInspectorHeader(props) {
  ...
  let t5;
  return $[20] !== children || $[21] !== forwardedAs || $[22] !== restProps || $[23] !== t4 ? (t5 = /* @__PURE__ */ jsxs(Root$2, { ...restProps, as: forwardedAs, children: [
    t4,
    children
...
const preventDefault = (ev) => ev.preventDefault(), FormView = forwardRef(function(props, ref) {
  ...
  let t5;
  $[13] !== documentId || $[14] !== documentStore || $[15] !== documentType || $[16] !== patchChannel ? (t5 = [documentId, documentStore, documentType, patchChannel], $[13] = documentId, $[14] = documentStore, $[15] = documentType, $[16] = patchChannel, $[17] = t5) : t5 = $[17], useEffect(t4, t5);
  ...
  }, t8 = [handleInitialValue, hasRev], $[21] = handleInitialValue, $[22] = hasRev, $[23] = t7, $[24] = t8) : (t7 = $[23], t8 = $[24]), useEffect(t7, t8);
  ...
  let t11;
  $[30] !== focusedFirstDescendant || $[31] !== formRef || $[32] !== ready || $[33] !== t10 ? (t11 = [focusedFirstDescendant, formRef, t10, ready], $[30] = focusedFirstDescendant, $[31] = formRef, $[32] = ready, $[33] = t10, $[34] = t11) : t11 = $[34], useEffect(t9, t11);
  let t12;
  $[35] !== ref ? (t12 = (node) => {
  ...
  let t14;
  $[61] !== setRef || $[62] !== t13 ? (t14 = /* @__PURE__ */ jsx(Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: t13 }), $[61] = setRef, $[62] = t13, $[63] = t14) : t14 = $[63];
  let t15;
  $[64] !== margins || $[65] !== t14 ? (t15 = /* @__PURE__ */ jsx(PresenceOverlay, { margins, children: t14 }), $[64] = margins, $[65] = t14, $[66] = t15) : t15 = $[66];
  let t16;
  return $[67] !== hidden || $[68] !== t15 ? (t16 = /* @__PURE__ */ jsx(Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[67] = hidden, $[68] = t15, $[69] = t16) : t16 = $[69], t16;
});
...
const DocumentBox = styled(Box)({
  ...
  let t13;
  $[56] !== documentId || $[57] !== rootElement || $[58] !== schemaType || $[59] !== showInspector ? (t13 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[56] = documentId, $[57] = rootElement, $[58] = schemaType, $[59] = showInspector, $[60] = t13) : t13 = $[60];
  let t14;
  return $[61] !== t12 || $[62] !== t13 ? (t14 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t12,
    t13
...
const DISABLED_REASON_KEY$1 = {
  ...
  $[3] !== documentStore.pair || $[4] !== duplicate || $[5] !== id || $[6] !== navigateIntent || $[7] !== onComplete || $[8] !== type ? (t2 = async () => {
    const dupeId = uuid();
    setDuplicating(!0);
    const duplicateSuccess = firstValueFrom(documentStore.pair.operationEvents(id, type).pipe(filter(_temp$9)));
...
const DocumentStatusBarActionsInner = memo(function(props) {
  ...
  const $ = c(16), {
    ...
    editState,
    timelineStore
  } = useDocumentPane(), revision = useTimelineSelector(timelineStore, _temp3$2)?.id || "", disabled = (editState?.draft || editState?.published || {})._rev === revision;
  let t0, t1;
...
const DocumentPanelHeader = memo(forwardRef(function(_props, ref) {
  ...
  return /* @__PURE__ */ jsx(TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabs, tabIndex, backButton, actions: renderedActions }) });
...
const DocumentPaneProvider = memo((props) => {
  ...
  }, [isPermissionsLoading, permissions?.granted, schemaType, isNonExistent, connectionState, editState.transactionSyncLock?.enabled, editState.draft, liveEdit, ready, revisionId, isDeleting, isDeleted, isCreateLinked]), patchRef = useRef(() => {
...
const DocumentPaneProviderWrapper = memo((props) => {
  ...
  useSource();
  let t0;
  return $[0] !== props ? (t0 = /* @__PURE__ */ jsx(DocumentPaneWithLegacyTimelineStore, { ...props }), $[0] = props, $[1] = t0) : t0 = $[1], t0;
});
...
function HistorySelector({
  ...
  const {
    ...
    setTimelineRange,
    timelineStore
  } = useDocumentPane(), [scrollRef, setScrollRef] = useState(null), [listHeight, setListHeight] = useState(0), getScrollerRef = useCallback((el) => {
  ...
  return /* @__PURE__ */ jsx(Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: /* @__PURE__ */ jsx(Card, { flex: 1, padding: 2, paddingTop: 0, children: timelineError ? /* @__PURE__ */ jsx(TimelineError, {}) : /* @__PURE__ */ jsx(BoundaryElementProvider, { element: scrollRef, children: /* @__PURE__ */ jsx(Scroller, { "data-ui": "Scroller", ref: getScrollerRef, children: listHeight && // This forces the list to unmount and remount, which is needed to reset the scroll position
