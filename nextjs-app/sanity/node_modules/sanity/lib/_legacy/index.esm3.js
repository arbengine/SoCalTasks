...
import { usePaneLayout, BackLink, ChildLink, ReferenceChildLink, ParameterizedLink, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, PaneHeader, PaneContent, Pane, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from "./pane.esm.js";
...
import { Stack, Text, Code, Box, Heading, Card, Container, Flex, useToast, useTheme, PortalProvider } from "@sanity/ui";
...
const DocumentTitle = (props) => {
  const $ = c(7), {
    ...
    t
  } = useTranslation(structureLocaleNamespace), isNewDocument = !editState?.published && !editState?.draft, documentValue = editState?.draft || editState?.published, schemaType = schema.get(documentType), {
    value,
