...
import { fetchSharedAccessQuery, urlSearchParamPreviewPerspective, urlSearchParamVercelProtectionBypass, urlSearchParamVercelSetBypassCookie, apiVersion, schemaIdSingleton, schemaTypeSingleton, schemaType } from "@sanity/preview-url-secret/constants";
import { Text, Stack, Inline, Box, Flex, Container as Container$1, Card, Code, Label, TextInput, Spinner, useToast, Menu, Grid, Switch, MenuDivider, Hotkeys, usePrefersReducedMotion, BoundaryElementProvider } from "@sanity/ui";
...
import { useTranslation, useUnique, getPublishedId, useDocumentPreviewStore, getPreviewStateObservable, useSchema, getPreviewValueWithFallback, SanityDefaultPreview, PreviewCard, Translate, CommentsIntentProvider, useActiveWorkspace, useClient, useCurrentUser, useEditState, useProjectId, useDataset, useWorkspace, COMMENTS_INSPECTOR_NAME, useGrantsStore } from "sanity";
...
import { WarningOutlineIcon, LaunchIcon, ResetIcon, ShareIcon, CopyIcon, PanelLeftIcon, RefreshIcon, ChevronDownIcon, EditIcon, CheckmarkIcon, PublishIcon, MobileDeviceIcon, DesktopIcon } from "@sanity/icons";
import { PaneRouterContext, PaneLayout, DocumentListPane as DocumentListPane$1, StructureToolProvider, DocumentPane as DocumentPane$1 } from "sanity/structure";
...
`, MotionSpinner = motion.create(Spinner), MotionText = motion.create(Text), MotionMonogram = motion.create(StyledSanityMonogram), SharePreviewMenu = memo(function(props) {
  ...
  }), currentUser = useCurrentUser(), [loading, setLoading] = useState(!0), [enabling, setEnabling] = useState(!1), [disabling, setDisabling] = useState(!1), [secret, setSecret] = useState(null), busy = enabling || disabling || loading, url = useMemo(() => secret ? setSecretSearchParams(initialUrl, secret, previewLocationRoute, perspective) : null, [initialUrl, perspective, previewLocationRoute, secret]), [error, setError] = useState(null);
  if (error)
    throw error;
...
const PERSPECTIVE_TITLE_KEY = {
  ...
  const t34 = PERSPECTIVE_TITLE_KEY[loadersConnection === "connected" ? perspective : "previewDrafts"];
  let t35;
  $[69] !== t || $[70] !== t34 ? (t35 = t(t34), $[69] = t, $[70] = t34, $[71] = t35) : t35 = $[71];
  const t36 = loadersConnection === "reconnecting" && iframe.status !== "loaded", t37 = loadersConnection !== "connected";
  let t38;
  $[72] !== t35 || $[73] !== t36 || $[74] !== t37 ? (t38 = /* @__PURE__ */ jsx(Button, { iconRight: ChevronDownIcon, mode: "bleed", text: t35, loading: t36, disabled: t37 }), $[72] = t35, $[73] = t36, $[74] = t37, $[75] = t38) : t38 = $[75];
  let t39;
  $[76] === Symbol.for("react.memo_cache_sentinel") ? (t39 = {
    maxWidth: 240
  }, $[76] = t39) : t39 = $[76];
  let t40;
  $[77] !== setPerspective ? (t40 = () => setPerspective("previewDrafts"), $[77] = setPerspective, $[78] = t40) : t40 = $[78];
  const t41 = perspective === "previewDrafts";
  let t42;
  $[79] !== perspective || $[80] !== t ? (t42 = () => /* @__PURE__ */ jsxs(Flex, { align: "flex-start", gap: 3, children: [
    /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(EditIcon, {}) }) }),
    ...
    /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { muted: !0, size: 1, style: {
      opacity: perspective === "previewDrafts" ? 1 : 0
    }, children: /* @__PURE__ */ jsx(CheckmarkIcon, {}) }) })
  ] }), $[79] = perspective, $[80] = t, $[81] = t42) : t42 = $[81];
  let t43;
  $[82] !== t40 || $[83] !== t41 || $[84] !== t42 ? (t43 = /* @__PURE__ */ jsx(MenuItem, { onClick: t40, pressed: t41, tone: PERSPECTIVE_TONES.previewDrafts, renderMenuItem: t42 }), $[82] = t40, $[83] = t41, $[84] = t42, $[85] = t43) : t43 = $[85];
  let t44;
  $[86] !== setPerspective ? (t44 = () => setPerspective("published"), $[86] = setPerspective, $[87] = t44) : t44 = $[87];
  const t45 = perspective === "published";
  let t46;
  $[88] !== perspective || $[89] !== t ? (t46 = () => /* @__PURE__ */ jsxs(Flex, { align: "flex-start", gap: 3, children: [
    /* @__PURE__ */ jsx(Box, { flex: "none", children: /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(PublishIcon, {}) }) }),
    /* @__PURE__ */ jsxs(Stack, { flex: 1, space: 2, children: [
  ...
  ] }), $[88] = perspective, $[89] = t, $[90] = t46) : t46 = $[90];
  let t47;
  $[91] !== t44 || $[92] !== t45 || $[93] !== t46 ? (t47 = /* @__PURE__ */ jsx(MenuItem, { onClick: t44, pressed: t45, tone: PERSPECTIVE_TONES.published, renderMenuItem: t46 }), $[91] = t44, $[92] = t45, $[93] = t46, $[94] = t47) : t47 = $[94];
  let t48;
  $[95] !== t43 || $[96] !== t47 ? (t48 = /* @__PURE__ */ jsxs(Menu, { style: t39, children: [
    t43,
    t47
  ] }), $[95] = t43, $[96] = t47, $[97] = t48) : t48 = $[97];
  let t49;
  $[98] === Symbol.for("react.memo_cache_sentinel") ? (t49 = {
    constrainSize: !0,
    placement: "bottom",
    portal: !0
  }, $[98] = t49) : t49 = $[98];
  let t50;
  $[99] !== t38 || $[100] !== t48 ? (t50 = /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(MenuButton, { button: t38, id: "perspective-menu", menu: t48, popover: t49 }) }), $[99] = t38, $[100] = t48, $[101] = t50) : t50 = $[101];
  const t51 = viewport === "desktop" ? "narrow" : "full";
  let t52;
  $[102] !== t || $[103] !== t51 ? (t52 = t("preview-frame.viewport-button.tooltip", {
    context: t51
  }), $[102] = t, $[103] = t51, $[104] = t52) : t52 = $[104];
  let t53;
  $[105] !== t52 ? (t53 = /* @__PURE__ */ jsx(Text, { size: 1, children: t52 }), $[105] = t52, $[106] = t53) : t53 = $[106];
  let t54;
  $[107] === Symbol.for("react.memo_cache_sentinel") ? (t54 = ["bottom-start"], $[107] = t54) : t54 = $[107];
  let t55;
  $[108] !== t ? (t55 = t("preview-frame.viewport-button.aria-label"), $[108] = t, $[109] = t55) : t55 = $[109];
  const t56 = viewport === "desktop" ? MobileDeviceIcon : DesktopIcon;
  let t57;
  $[110] !== t55 || $[111] !== t56 || $[112] !== toggleViewportSize ? (t57 = /* @__PURE__ */ jsx(Button, { "aria-label": t55, icon: t56, mode: "bleed", onClick: toggleViewportSize, tooltipProps: null }), $[110] = t55, $[111] = t56, $[112] = toggleViewportSize, $[113] = t57) : t57 = $[113];
  let t58;
  $[114] !== t53 || $[115] !== t57 ? (t58 = /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(Tooltip, { animate: !0, content: t53, fallbackPlacements: t54, placement: "bottom", portal: !0, children: t57 }) }), $[114] = t53, $[115] = t57, $[116] = t58) : t58 = $[116];
  let t59;
  $[117] !== canSharePreviewAccess || $[118] !== canToggleSharePreviewAccess || $[119] !== canUseSharedPreviewAccess || $[120] !== initialUrl || $[121] !== perspective || $[122] !== previewLocationRoute ? (t59 = canSharePreviewAccess && /* @__PURE__ */ jsx(Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsx(SharePreviewMenu, { canToggleSharePreviewAccess, canUseSharedPreviewAccess, previewLocationRoute, initialUrl, perspective }) }), $[117] = canSharePreviewAccess, $[118] = canToggleSharePreviewAccess, $[119] = canUseSharedPreviewAccess, $[120] = initialUrl, $[121] = perspective, $[122] = previewLocationRoute, $[123] = t59) : t59 = $[123];
  let t60;
  return $[124] !== t24 || $[125] !== t33 || $[126] !== t50 || $[127] !== t58 || $[128] !== t59 || $[129] !== t6 ? (t60 = /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 1, paddingX: 1, style: t5, children: [
    t6,
    t24,
    t33,
    t50,
    t58,
    t59
  ] }), $[124] = t24, $[125] = t33, $[126] = t50, $[127] = t58, $[128] = t59, $[129] = t6, $[130] = t60) : t60 = $[130], t60;
};
...
function useEffectOnChange(value, _callback, initialValue, comparator) {
  const $ = c(5), previousValueRef = useRef(initialValue), callback = useEffectEvent(_callback);
  let t0, t1;
  $[0] !== callback || $[1] !== comparator || $[2] !== value ? (t0 = () => {
    const prev = previousValueRef.current;
    if (previousValueRef.current = value, value !== prev)
      return callback(value, prev);
  }, t1 = [callback, comparator, value], $[0] = callback, $[1] = comparator, $[2] = value, $[3] = t0, $[4] = t1) : (t0 = $[3], t1 = $[4]), useEffect(t0, t1);
}
const RevisionSwitcher = function(props) {
  const $ = c(4), {
    ...
    perspective,
    documentRevision
  } = props, editState = useEditState(documentId, documentType);
  let t0;
...
function PresentationTool(props) {
  const {
    ...
    routerSearchParams,
    frameStateRef
  }), navigate = useMemo(() => debounce(_navigate, 50), [_navigate]), [state, dispatch] = useReducer(presentationReducer, {}, presentationReducerInit), perspective = useMemo(() => params.perspective ? "published" : "previewDrafts", [params.perspective]), viewport = useMemo(() => params.viewport ? "mobile" : "desktop", [params.viewport]), [documentsOnPage, setDocumentsOnPage] = useDocumentsOnPage(perspective, frameStateRef), projectId = useProjectId(), dataset = useDataset(), mainDocumentState = useMainDocument({
  ...
  const refreshRef = useRef(void 0), handleRefresh = useCallback((fallback) => {
    if (dispatch({
      type: ACTION_IFRAME_REFRESH
  ...
  }, [navigate]), setPerspective = useCallback((next_0) => {
    navigate({}, {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Suspense, { children: [
      controller && /* @__PURE__ */ jsx(LoaderQueries, { controller, perspective, liveDocument: displayedDocument, onDocumentsOnPage: setDocumentsOnPage, onLoadersConnection: setLoadersConnection, documentsOnPage }),
      ...
      visualEditingComlink && /* @__PURE__ */ jsx(PostMessageDocuments, { comlink: visualEditingComlink }),
      ...
      params.id && params.type && /* @__PURE__ */ jsx(RevisionSwitcher, { documentId: params.id, documentRevision: params.rev, documentType: params.type, navigate, perspective })
    ] })
  ] });
}
