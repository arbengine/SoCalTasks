...
`, MotionSpinner = framerMotion.motion.create(ui.Spinner), MotionText = framerMotion.motion.create(ui.Text), MotionMonogram = framerMotion.motion.create(StyledSanityMonogram), SharePreviewMenu = React.memo(function(props) {
  ...
  const handleUnableToToggle = React.useCallback(() => {
    ...
    try {
      setDisabling(!0), await togglePreviewAccessSharing.disablePreviewAccessSharing(client, "@sanity/presentation", typeof window > "u" ? "" : location.href, currentUser?.id), setSecret(null);
    } catch (error_0) {
      setError(error_0);
    } finally {
      setDisabling(!1);
    ...
    try {
      setEnabling(!0);
      const previewUrlSecret = await togglePreviewAccessSharing.enablePreviewAccessSharing(client, "@sanity/presentation", typeof window > "u" ? "" : location.href, currentUser?.id);
  ...
  }, [client]), /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuButton, { button: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t("preview-frame.share-button.aria-label"), icon: icons.ShareIcon, mode: "bleed", tooltipProps: null }), id: "share-menu", menu: /* @__PURE__ */ jsxRuntime.jsx(ui.Menu, { style: {
    maxWidth: 248
...
const PERSPECTIVE_TITLE_KEY = {
  ...
  const $ = reactCompilerRuntime.c(131), {
  ...
  let t38;
  $[72] !== t35 || $[73] !== t36 || $[74] !== t37 ? (t38 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { iconRight: icons.ChevronDownIcon, mode: "bleed", text: t35, loading: t36, disabled: t37 }), $[72] = t35, $[73] = t36, $[74] = t37, $[75] = t38) : t38 = $[75];
  let t39;
  ...
  let t42;
  $[79] !== perspective || $[80] !== t ? (t42 = () => /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "flex-start", gap: 3, children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(icons.EditIcon, {}) }) }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { muted: !0, size: 1, style: {
  ...
  let t43;
  $[82] !== t40 || $[83] !== t41 || $[84] !== t42 ? (t43 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuItem, { onClick: t40, pressed: t41, tone: PERSPECTIVE_TONES.previewDrafts, renderMenuItem: t42 }), $[82] = t40, $[83] = t41, $[84] = t42, $[85] = t43) : t43 = $[85];
  let t44;
  $[86] !== setPerspective ? (t44 = () => setPerspective("published"), $[86] = setPerspective, $[87] = t44) : t44 = $[87];
  const t45 = perspective === "published";
  let t46;
  $[88] !== perspective || $[89] !== t ? (t46 = () => /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "flex-start", gap: 3, children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(icons.PublishIcon, {}) }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { flex: 1, space: 2, children: [
  ...
  let t47;
  $[91] !== t44 || $[92] !== t45 || $[93] !== t46 ? (t47 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuItem, { onClick: t44, pressed: t45, tone: PERSPECTIVE_TONES.published, renderMenuItem: t46 }), $[91] = t44, $[92] = t45, $[93] = t46, $[94] = t47) : t47 = $[94];
  let t48;
  $[95] !== t43 || $[96] !== t47 ? (t48 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Menu, { style: t39, children: [
    t43,
    t47
  ...
  let t50;
  $[99] !== t38 || $[100] !== t48 ? (t50 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuButton, { button: t38, id: "perspective-menu", menu: t48, popover: t49 }) }), $[99] = t38, $[100] = t48, $[101] = t50) : t50 = $[101];
  ...
  let t53;
  $[105] !== t52 ? (t53 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: t52 }), $[105] = t52, $[106] = t53) : t53 = $[106];
  let t54;
  ...
  const t56 = viewport === "desktop" ? icons.MobileDeviceIcon : icons.DesktopIcon;
  let t57;
  $[110] !== t55 || $[111] !== t56 || $[112] !== toggleViewportSize ? (t57 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t55, icon: t56, mode: "bleed", onClick: toggleViewportSize, tooltipProps: null }), $[110] = t55, $[111] = t56, $[112] = toggleViewportSize, $[113] = t57) : t57 = $[113];
  let t58;
  $[114] !== t53 || $[115] !== t57 ? (t58 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { animate: !0, content: t53, fallbackPlacements: t54, placement: "bottom", portal: !0, children: t57 }) }), $[114] = t53, $[115] = t57, $[116] = t58) : t58 = $[116];
  let t59;
  $[117] !== canSharePreviewAccess || $[118] !== canToggleSharePreviewAccess || $[119] !== canUseSharedPreviewAccess || $[120] !== initialUrl || $[121] !== perspective || $[122] !== previewLocationRoute ? (t59 = canSharePreviewAccess && /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: "none", gap: 1, children: /* @__PURE__ */ jsxRuntime.jsx(SharePreviewMenu, { canToggleSharePreviewAccess, canUseSharedPreviewAccess, previewLocationRoute, initialUrl, perspective }) }), $[117] = canSharePreviewAccess, $[118] = canToggleSharePreviewAccess, $[119] = canUseSharedPreviewAccess, $[120] = initialUrl, $[121] = perspective, $[122] = previewLocationRoute, $[123] = t59) : t59 = $[123];
  let t60;
  return $[124] !== t24 || $[125] !== t33 || $[126] !== t50 || $[127] !== t58 || $[128] !== t59 || $[129] !== t6 ? (t60 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 1, paddingX: 1, style: t5, children: [
    t6,
    t24,
    t33,
    t50,
...
function useMainDocument(props) {
  const {
    ...
    state: routerState
  } = router.useRouter(), client = sanity.useClient({
    apiVersion: presentation.API_VERSION
...
function usePreviewUrlSecret(enabled, deps) {
  ...
  let t1;
  $[1] !== client || $[2] !== currentUser?.id || $[3] !== deps || $[4] !== enabled || $[5] !== secretLastExpiredAt ? (t1 = enabled ? suspendReact.suspend(async () => await createSecret.createPreviewSecret(client, "@sanity/presentation", typeof window > "u" ? "" : location.href, currentUser?.id), [...deps, secretLastExpiredAt]) : null, $[1] = client, $[2] = currentUser?.id, $[3] = deps, $[4] = enabled, $[5] = secretLastExpiredAt, $[6] = t1) : t1 = $[6];
...
const LoaderQueries = React.lazy(() => Promise.resolve().then(function() {
  return require("./LoaderQueries.js");
}));
...
function PresentationTool(props) {
  ...
  const refreshRef = React.useRef(void 0), handleRefresh = React.useCallback((fallback) => {
    if (dispatch({
      type: presentation.ACTION_IFRAME_REFRESH
...
function useVercelBypassSecret() {
  ...
  const client = sanity.useClient(t0), [vercelProtectionBypassReadyState, ready] = React.useReducer(_temp, "loading"), [vercelProtectionBypassSecret, setVercelProtectionBypassSecret] = React.useState(null);
  let t1, t2;
  $[1] !== client ? (t1 = () => {
    const unsubscribe = toggleVercelProtectionBypass.subcribeToVercelProtectionBypass(client, (secret) => {
      setVercelProtectionBypassSecret(secret), ready();
    });
    return () => unsubscribe();
  }, t2 = [client], $[1] = client, $[2] = t1, $[3] = t2) : (t1 = $[2], t2 = $[3]), React.useEffect(t1, t2);
  let t3;
