...
const DocumentTitle = (props) => {
  const $ = reactCompilerRuntime.c(7), {
    documentId,
    documentType
  } = props, editState = sanity.useEditState(documentId, documentType), schema = sanity.useSchema(), {
    t
  } = sanity.useTranslation(structure.structureLocaleNamespace), isNewDocument = !editState?.published && !editState?.draft, documentValue = editState?.draft || editState?.published, schemaType = schema.get(documentType), {
    value,
