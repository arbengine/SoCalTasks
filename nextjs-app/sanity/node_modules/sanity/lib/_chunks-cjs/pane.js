...
function PaneItemPreview(props) {
  ...
  let t0, t1;
  $[0] !== props.documentPreviewStore || $[1] !== schemaType || $[2] !== title || $[3] !== value._id ? (t1 = sanity.getPreviewStateObservable(props.documentPreviewStore, schemaType, value._id, title), $[0] = props.documentPreviewStore, $[1] = schemaType, $[2] = title, $[3] = value._id, $[4] = t1) : t1 = $[4], t0 = t1;
  ...
  const {
    ...
    published,
    isLoading
  } = reactRx.useObservable(previewStateObservable, t2);
  let t3;
  $[6] !== draft || $[7] !== isLoading || $[8] !== presence || $[9] !== published ? (t3 = isLoading ? null : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
  ...
  const status = t3;
  let t4;
  $[11] !== draft || $[12] !== published ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatus, { draft, published }), $[11] = draft, $[12] = published, $[13] = t4) : t4 = $[13];
  const tooltip = t4;
  let t5;
  $[14] !== draft || $[15] !== published || $[16] !== value ? (t5 = sanity.getPreviewValueWithFallback({
    value,
    draft,
    published
  }), $[14] = draft, $[15] = published, $[16] = value, $[17] = t5) : t5 = $[17];
  let t6;
  return $[18] !== icon || $[19] !== isLoading || $[20] !== layout || $[21] !== status || $[22] !== t5 || $[23] !== tooltip ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { ...t5, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[18] = icon, $[19] = isLoading, $[20] = layout, $[21] = status, $[22] = t5, $[23] = tooltip, $[24] = t6) : t6 = $[24], t6;
}
    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { overflow: "auto", paddingTop: 2, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(Table$1, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$i).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
function useReferringDocuments(documentId) {
  ...
  let t5;
  $[8] !== crossDatasetReferences?.references ? (t5 = () => Array.from(new Set(crossDatasetReferences?.references.map(_temp$h).filter(Boolean))).sort(), $[8] = crossDatasetReferences?.references, $[9] = t5) : t5 = $[9];
  let t6;
  $[10] !== t5 ? (t6 = t5(), $[10] = t5, $[11] = t6) : t6 = $[11];
  const projectIds = t6;
  let t7, t8;
  $[12] !== crossDatasetReferences?.references ? (t8 = Array.from(new Set(crossDatasetReferences?.references.map(_temp2$7).filter(_temp3$3))).sort(), $[12] = crossDatasetReferences?.references, $[13] = t8) : t8 = $[13], t7 = t8;
...
const PANE_DEBUG = !1, PANE_COLLAPSED_WIDTH = 51, PANE_DEFAULT_MIN_WIDTH = 204, Root$8 = styledComponents.styled(ui.Layer)`
  position: relative;
  width: 1px;
  min-width: 1px;
...
function PaneDivider(t0) {
  ...
  let t4;
  return $[3] !== handleMouseDown || $[4] !== t2 || $[5] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(Root$8, { "data-disabled": t2, "data-dragging": t3, onMouseDown: handleMouseDown }), $[3] = handleMouseDown, $[4] = t2, $[5] = t3, $[6] = t4) : t4 = $[6], t4;
}
const Root$7 = styledComponents.styled(ui.Card)`
  outline: none;
...
`, Pane = React.forwardRef(function(props, forwardedRef) {
  ...
  let t25;
  $[66] !== hidden || $[67] !== id || $[68] !== paneIndex || $[69] !== restProps || $[70] !== style || $[71] !== t19 || $[72] !== t20 || $[73] !== t21 || $[74] !== t22 || $[75] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsxs(Root$7, { "data-testid": "pane", "data-ui": "Pane", tone: "inherit", hidden, id, overflow: t19, ...restProps, "data-pane-collapsed": t20, "data-pane-index": paneIndex, "data-pane-selected": t21, ref: setRef, style, children: [
    t22,
    t24
...
}), Root$6 = styledComponents.styled(ui.Card)`
  position: relative;
  outline: none;
`;
Root$6.displayName = "PaneContent__root";
function usePane() {
...
const PaneContent = React.forwardRef(function(props, ref) {
  ...
  let t1;
  return $[6] !== as || $[7] !== children || $[8] !== collapsed || $[9] !== padding || $[10] !== ref || $[11] !== restProps || $[12] !== t0 ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(Root$6, { "data-testid": "pane-content", forwardedAs: as, ...restProps, flex: 1, hidden: collapsed, overflow: t0, padding, ref, tone: "inherit", children }), $[6] = as, $[7] = children, $[8] = collapsed, $[9] = padding, $[10] = ref, $[11] = restProps, $[12] = t0, $[13] = t1) : t1 = $[13], t1;
});
...
const Root$5 = styledComponents.styled(ui.Layer)`
  position: sticky;
  bottom: 0;
...
`, PaneFooter = React.forwardRef(function(props, ref) {
  ...
  let t1;
  return $[3] !== collapsed || $[4] !== ref || $[5] !== t0 ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(sanity.LegacyLayerProvider, { zOffset: "paneFooter", children: /* @__PURE__ */ jsxRuntime.jsx(Root$5, { "data-testid": "pane-footer", hidden: collapsed, ref, children: t0 }) }), $[3] = collapsed, $[4] = ref, $[5] = t0, $[6] = t1) : t1 = $[6], t1;
}), Root$4 = styledComponents.styled(ui.Layer)(({
  $border
...
`, TabsBox = styledComponents.styled(ui.Box)(({
  ...
  let t10;
  $[10] !== loading ? (t10 = loading && /* @__PURE__ */ jsxRuntime.jsx(TitleTextSkeleton, { animated: !0, radius: 1, size: 1 }), $[10] = loading, $[11] = t10) : t10 = $[11];
  let t11;
  ...
  let t12;
  $[15] !== handleTitleClick || $[16] !== t10 || $[17] !== t11 || $[18] !== t9 || $[19] !== tabIndex ? (t12 = /* @__PURE__ */ jsxRuntime.jsxs(TitleCard, { __unstable_focusRing: !0, flex: 1, forwardedAs: "button", onClick: handleTitleClick, paddingLeft: t9, padding: 2, tabIndex, children: [
    t10,
    t11
  ] }), $[15] = handleTitleClick, $[16] = t10, $[17] = t11, $[18] = t9, $[19] = tabIndex, $[20] = t12) : t12 = $[20];
  let t13;
  $[21] !== actions || $[22] !== collapsed ? (t13 = actions && /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", hidden: collapsed, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.LegacyLayerProvider, { zOffset: "paneHeader", children: actions }) }), $[21] = actions, $[22] = collapsed, $[23] = t13) : t13 = $[23];
  let t14;
  ...
  let t18;
  return $[41] !== border || $[42] !== ref || $[43] !== t17 || $[44] !== t5 ? (t18 = /* @__PURE__ */ jsxRuntime.jsx(ui.LayerProvider, { zOffset: 100, children: /* @__PURE__ */ jsxRuntime.jsx(Root$4, { $border: border, "data-collapsed": t5, "data-testid": "pane-header", ref, children: t17 }) }), $[41] = border, $[42] = ref, $[43] = t17, $[44] = t5, $[45] = t18) : t18 = $[45], t18;
});
...
function PaneLayout(props) {
  ...
  const [controller] = React.useState(_temp$g), [rootElement, setRootElement] = React.useState(null), width = ui.useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
  ...
  let t14;
  $[32] !== children || $[33] !== restProps || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(Root$3, { "data-ui": "PaneLayout", ...restProps, "data-collapsed": t11, "data-resizing": t12, "data-mounted": t13, ref: setRootElement, children }), $[32] = children, $[33] = restProps, $[34] = t11, $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37];
  let t15;
...
function PaneHeaderCreateButton(t0) {
  const $ = reactCompilerRuntime.c(59), {
    templateItems
  } = t0, schema = sanity.useSchema(), templates = sanity.useTemplates(), {
    t
  } = sanity.useTranslation(structureLocaleNamespace);
  let t1;
  ...
  bb0: {
    ...
    let t52;
    $[6] !== templatePermissions ? (t52 = templatePermissions.reduce(_temp2$6, {}), $[6] = templatePermissions, $[7] = t52) : t52 = $[7], t4 = t52;
  }
  ...
  if (templateItems.length === 1) {
    ...
    let t92;
    $[25] !== disabled || $[26] !== intent || $[27] !== t62.title || $[28] !== t72 || $[29] !== t82 ? (t92 = /* @__PURE__ */ jsxRuntime.jsx(IntentButton, { "aria-label": t62.title, icon: t72, intent, mode: "bleed", disabled, "data-testid": "action-intent-button", tooltipProps: t82 }), $[25] = disabled, $[26] = intent, $[27] = t62.title, $[28] = t72, $[29] = t82, $[30] = t92) : t92 = $[30];
    let t10;
    return $[31] !== disabled || $[32] !== isTemplatePermissionsLoading || $[33] !== t92 ? (t10 = /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionsMessageTooltip, { reveal: disabled, loading: isTemplatePermissionsLoading, context: "create-document-type", children: t92 }), $[31] = disabled, $[32] = isTemplatePermissionsLoading, $[33] = t92, $[34] = t10) : t10 = $[34], t10;
  }
  let t5;
  $[35] !== t ? (t5 = t("pane-header.create-new-button.tooltip"), $[35] = t, $[36] = t5) : t5 = $[36];
  let t6;
  $[37] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { icon: icons.AddIcon, mode: "bleed", "data-testid": "multi-action-intent-button", tooltipProps: {
    content: t5
  } }), $[37] = t5, $[38] = t6) : t6 = $[38];
  let t7;
  if ($[39] !== getI18nText || $[40] !== isTemplatePermissionsLoading || $[41] !== permissionsById || $[42] !== schema || $[43] !== t || $[44] !== templateItems || $[45] !== templates) {
    ...
    $[47] !== getI18nText || $[48] !== isTemplatePermissionsLoading || $[49] !== permissionsById || $[50] !== schema || $[51] !== t || $[52] !== templates ? (t82 = (item, itemIndex) => {
      ...
      if (!template || !intent_0)
        return null;
      const Link = React.forwardRef((linkProps, linkRef) => disabled_0 ? /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", disabled: !0, ...linkProps, ref: linkRef }) : /* @__PURE__ */ jsxRuntime.jsx(router$1.IntentLink, { ...linkProps, intent: intent_0.type, params: intent_0.params, ref: linkRef }));
    ...
    t7 = $[46];
  let t8;
  $[54] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(ui.Menu, { children: t7 }), $[54] = t7, $[55] = t8) : t8 = $[55];
  let t9;
  return $[56] !== t6 || $[57] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuButton, { button: t6, id: "create-menu", menu: t8, popover: POPOVER_PROPS }), $[56] = t6, $[57] = t8, $[58] = t9) : t9 = $[58], t9;
}
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$e, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$e() {
...
`, LoadingPane = React.memo((props) => {
  ...
  let t11;
  $[15] !== t10 || $[16] !== t8 ? (t11 = /* @__PURE__ */ jsxRuntime.jsx(Content$1, { align: "center", "data-mounted": t8, direction: "column", height: "fill", justify: "center", ref: setContentElement, children: t10 }), $[15] = t10, $[16] = t8, $[17] = t11) : t11 = $[17];
  const content = t11;
  let t12;
...
}), isLiveEditEnabled = (schemaType) => schemaType.liveEdit === !0, Root$2 = styledComponents.styled(ui.Card)({
  position: "relative",
  zIndex: 1,
  lineHeight: 0
});
function DocumentInspectorHeader(props) {
  ...
  let t5;
  return $[20] !== children || $[21] !== forwardedAs || $[22] !== restProps || $[23] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(Root$2, { ...restProps, as: forwardedAs, children: [
    t4,
    children
...
function Banner(props) {
  ...
  let t1;
  $[6] !== Icon ? (t1 = Icon && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 0, children: /* @__PURE__ */ jsxRuntime.jsx(Icon, {}) }), $[6] = Icon, $[7] = t1) : t1 = $[7];
  let t2;
  $[8] !== content ? (t2 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: 1, gap: 2, paddingY: 3, children: content }), $[8] = content, $[9] = t2) : t2 = $[9];
  let t3;
  $[10] !== action ? (t3 = action && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...action, mode: action.mode || "ghost", tone: action.tone || "default" }), $[10] = action, $[11] = t3) : t3 = $[11];
  let t4;
  $[12] !== t1 || $[13] !== t2 || $[14] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
    t1,
    t2,
    t3
  ] }), $[12] = t1, $[13] = t2, $[14] = t3, $[15] = t4) : t4 = $[15];
  let t5;
  return $[16] !== rest || $[17] !== t4 || $[18] !== tone ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { borderBottom: !0, paddingX: 4, paddingY: 2, tone, ...rest, children: t4 }), $[16] = rest, $[17] = t4, $[18] = tone, $[19] = t5) : t5 = $[19], t5;
}
...
function RequestPermissionDialog(t0) {
  ...
  bb0: {
    ...
    if ($[2] !== client.observable || $[3] !== projectId) {
      let t42;
      $[5] === Symbol.for("react.memo_cache_sentinel") ? (t42 = (roles) => roles.filter(_temp$d).find(_temp2$5) ? "editor" : adminRole, $[5] = t42) : t42 = $[5];
      let t52;
...
function InsufficientPermissionBanner(t0) {
  ...
  let roleTitles, t4;
  $[3] !== currentUserRoles || $[4] !== listFormat ? (roleTitles = currentUserRoles.map(_temp$c), t4 = listFormat.formatToParts(roleTitles).map(_temp2$4), $[3] = currentUserRoles, $[4] = listFormat, $[5] = roleTitles, $[6] = t4) : (roleTitles = $[5], t4 = $[6]);
  const roles = t4;
  let t5;
  $[7] !== roles ? (t5 = {
...
const ReferenceChangedBanner = React.memo(() => {
  ...
  }, [documentPreviewStore, parentId, parentRefPath]), referenceInfo = reactRx.useObservable(referenceInfoObservable, {
    loading: !0
...
function DraftLiveEditBanner(t0) {
  ...
  }, $[6] = t3) : t3 = $[6], React.useEffect(t3), displayed && displayed._id && !sanity.isDraftId(displayed._id))
    return null;
  let t4;
  ...
  let t14;
  return $[34] !== t13 || $[35] !== t5 || $[36] !== t9 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { content: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", justify: "space-between", gap: 1, children: [
    t5,
    t9,
    t13
...
const preventDefault = (ev) => ev.preventDefault(), FormView = React.forwardRef(function(props, ref) {
  const $ = reactCompilerRuntime.c(70), {
    ...
    openPath
  } = useDocumentPane(), documentStore = sanity.useDocumentStore(), presence = sanity.useDocumentPresence(documentId), {
    title
  } = useDocumentTitle(), [patchChannel] = React.useState(_temp$b), isLocked = editState?.transactionSyncLock?.enabled, {
    t
  } = sanity.useTranslation(structureLocaleNamespace);
  let t0, t1;
  ...
  let t4;
  $[8] !== documentId || $[9] !== documentStore.pair || $[10] !== documentType || $[11] !== patchChannel ? (t4 = () => {
  ...
  }, $[8] = documentId, $[9] = documentStore.pair, $[10] = documentType, $[11] = patchChannel, $[12] = t4) : t4 = $[12];
  let t5;
  $[13] !== documentId || $[14] !== documentStore || $[15] !== documentType || $[16] !== patchChannel ? (t5 = [documentId, documentStore, documentType, patchChannel], $[13] = documentId, $[14] = documentStore, $[15] = documentType, $[16] = patchChannel, $[17] = t5) : t5 = $[17], React.useEffect(t4, t5);
  const hasRev = !!value?._rev;
  let t6;
  $[18] !== patchChannel || $[19] !== value ? (t6 = () => {
    patchChannel.publish({
      type: "mutation",
      patches: [],
      snapshot: value
    });
  }, $[18] = patchChannel, $[19] = value, $[20] = t6) : t6 = $[20];
  const handleInitialValue = useEffectEvent.useEffectEvent(t6);
  let t7, t8;
  $[21] !== handleInitialValue || $[22] !== hasRev ? (t7 = () => {
    hasRev && handleInitialValue();
  }, t8 = [handleInitialValue, hasRev], $[21] = handleInitialValue, $[22] = hasRev, $[23] = t7, $[24] = t8) : (t7 = $[23], t8 = $[24]), React.useEffect(t7, t8);
  const [formRef, setFormRef] = React.useState(null), [focusedFirstDescendant, setFocusedFirstDescendant] = React.useState(!1);
  let t9;
  $[25] !== focusedFirstDescendant || $[26] !== formRef || $[27] !== formState?.focusPath.length || $[28] !== ready ? (t9 = () => {
  ...
  }, $[25] = focusedFirstDescendant, $[26] = formRef, $[27] = formState?.focusPath.length, $[28] = ready, $[29] = t9) : t9 = $[29];
  const t10 = formState?.focusPath.length;
  let t11;
  $[30] !== focusedFirstDescendant || $[31] !== formRef || $[32] !== ready || $[33] !== t10 ? (t11 = [focusedFirstDescendant, formRef, t10, ready], $[30] = focusedFirstDescendant, $[31] = formRef, $[32] = ready, $[33] = t10, $[34] = t11) : t11 = $[34], React.useEffect(t9, t11);
  let t12;
  $[35] !== ref ? (t12 = (node) => {
    setFormRef(node), typeof ref == "function" ? ref(node) : ref && (ref.current = node);
  }, $[35] = ref, $[36] = t12) : t12 = $[36];
  const setRef = t12;
  let t13;
  $[37] !== collapsedFieldSets || $[38] !== collapsedPaths || $[39] !== connectionState || $[40] !== documentId || $[41] !== editState?.draft || $[42] !== editState?.published || $[43] !== editState?.ready || $[44] !== fieldActions || $[45] !== formState || $[46] !== hidden || $[47] !== onBlur || $[48] !== onChange || $[49] !== onFocus || $[50] !== onPathOpen || $[51] !== onSetActiveFieldGroup || $[52] !== onSetCollapsedFieldSet || $[53] !== onSetCollapsedPath || $[54] !== openPath || $[55] !== patchChannel || $[56] !== presence || $[57] !== t || $[58] !== title || $[59] !== validation ? (t13 = connectionState === "connecting" && !editState?.draft && !editState?.published ? /* @__PURE__ */ jsxRuntime.jsx(Delay, { ms: 300, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
  ...
  ] }), $[37] = collapsedFieldSets, $[38] = collapsedPaths, $[39] = connectionState, $[40] = documentId, $[41] = editState?.draft, $[42] = editState?.published, $[43] = editState?.ready, $[44] = fieldActions, $[45] = formState, $[46] = hidden, $[47] = onBlur, $[48] = onChange, $[49] = onFocus, $[50] = onPathOpen, $[51] = onSetActiveFieldGroup, $[52] = onSetCollapsedFieldSet, $[53] = onSetCollapsedPath, $[54] = openPath, $[55] = patchChannel, $[56] = presence, $[57] = t, $[58] = title, $[59] = validation, $[60] = t13) : t13 = $[60];
  let t14;
  $[61] !== setRef || $[62] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: t13 }), $[61] = setRef, $[62] = t13, $[63] = t14) : t14 = $[63];
  let t15;
  $[64] !== margins || $[65] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(sanity.PresenceOverlay, { margins, children: t14 }), $[64] = margins, $[65] = t14, $[66] = t15) : t15 = $[66];
  let t16;
  return $[67] !== hidden || $[68] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[67] = hidden, $[68] = t15, $[69] = t16) : t16 = $[69], t16;
});
...
const DocumentBox = styledComponents.styled(ui.Box)({
  position: "relative"
}), Scroller$2 = styledComponents.styled(sanity.ScrollContainer)(({
  $disabled
}) => $disabled ? {
  height: "100%"
} : styledComponents.css`
  ...
  $[34] !== activeView.type || $[35] !== activeViewNode || $[36] !== displayed || $[37] !== documentId || $[38] !== documentScrollElement || $[39] !== features.resizablePanes || $[40] !== formViewHidden || $[41] !== inspectDialog || $[42] !== isDeleted || $[43] !== isDeleting || $[44] !== isLiveEdit || $[45] !== isPermissionsLoading || $[46] !== lastNonDeletedRevId || $[47] !== layoutCollapsed || $[48] !== margins || $[49] !== permissions?.granted || $[50] !== portalElement || $[51] !== ready || $[52] !== requiredPermission || $[53] !== schemaType || $[54] !== showInspector ? (t12 = (features.resizablePanes || !showInspector) && /* @__PURE__ */ jsxRuntime.jsx(DocumentBox, { flex: 2, overflow: "hidden", children: /* @__PURE__ */ jsxRuntime.jsx(ui.PortalProvider, { element: portalElement, __unstable_elements: {
    ...
    activeView.type === "form" && isLiveEdit && ready && /* @__PURE__ */ jsxRuntime.jsx(DraftLiveEditBanner, { displayed, documentId, schemaType }),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(Scroller$2, { $disabled: layoutCollapsed || !1, "data-testid": "document-panel-scroller", ref: setDocumentScrollElement, children: [
  ...
  ] }) }) }) }), $[34] = activeView.type, $[35] = activeViewNode, $[36] = displayed, $[37] = documentId, $[38] = documentScrollElement, $[39] = features.resizablePanes, $[40] = formViewHidden, $[41] = inspectDialog, $[42] = isDeleted, $[43] = isDeleting, $[44] = isLiveEdit, $[45] = isPermissionsLoading, $[46] = lastNonDeletedRevId, $[47] = layoutCollapsed, $[48] = margins, $[49] = permissions?.granted, $[50] = portalElement, $[51] = ready, $[52] = requiredPermission, $[53] = schemaType, $[54] = showInspector, $[55] = t12) : t12 = $[55];
  let t13;
  $[56] !== documentId || $[57] !== rootElement || $[58] !== schemaType || $[59] !== showInspector ? (t13 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[56] = documentId, $[57] = rootElement, $[58] = schemaType, $[59] = showInspector, $[60] = t13) : t13 = $[60];
  let t14;
  return $[61] !== t12 || $[62] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t12,
    t13
...
function ActionMenuListItem(props) {
  ...
  let t1, t2;
  $[4] !== actionState.shortcut ? (t2 = actionState.shortcut ? String(actionState.shortcut).split("+").map(_temp$a) : void 0, $[4] = actionState.shortcut, $[5] = t2) : t2 = $[5], t1 = t2;
...
const DISABLED_REASON_TITLE_KEY$1 = {
  ...
  const $ = reactCompilerRuntime.c(35), {
    ...
    delete: deleteOp
  } = sanity.useDocumentOperation(id, type), [isDeleting, setIsDeleting] = React.useState(!1), [isConfirmDialogOpen, setConfirmDialogOpen] = React.useState(!1), {
    t
  } = sanity.useTranslation(structureLocaleNamespace);
  let t1;
  $[0] !== onComplete ? (t1 = () => {
  ...
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t72;
      $[12] !== currentUser ? (t72 = /* @__PURE__ */ jsxRuntime.jsx(sanity.InsufficientPermissionsMessage, { context: "delete-document", currentUser }), $[12] = currentUser, $[13] = t72) : t72 = $[13];
      let t82;
      $[14] !== t62 || $[15] !== t72 ? (t82 = {
        tone: "critical",
...
const DISABLED_REASON_KEY$1 = {
  ...
  $[3] !== documentStore.pair || $[4] !== duplicate || $[5] !== id || $[6] !== navigateIntent || $[7] !== onComplete || $[8] !== type ? (t2 = async () => {
    ...
    setDuplicating(!0);
    const duplicateSuccess = rxjs.firstValueFrom(documentStore.pair.operationEvents(id, type).pipe(rxjs.filter(_temp$9)));
  ...
  bb0: {
    if (!isPermissionsLoading && !permissions?.granted) {
      ...
      let t52;
      $[12] !== currentUser ? (t52 = /* @__PURE__ */ jsxRuntime.jsx(sanity.InsufficientPermissionsMessage, { context: "duplicate-document", currentUser }), $[12] = currentUser, $[13] = t52) : t52 = $[13];
      let t62;
      $[14] !== t42 || $[15] !== t52 ? (t62 = {
        icon: icons.CopyIcon,
        disabled: !0,
...
const HistoryRestoreAction = (t0) => {
  const $ = reactCompilerRuntime.c(27), {
    ...
    restore
  } = sanity.useDocumentOperation(id, type), event = sanity.useDocumentOperationEvent(id, type), {
    navigateIntent
...
const DocumentStatusBarActionsInner = React.memo(function(props) {
  ...
  bb0: {
    ...
    $[6] !== firstActionState.shortcut ? (t32 = firstActionState.shortcut && /* @__PURE__ */ jsxRuntime.jsx(sanity.Hotkeys, { "data-testid": "document-status-bar-hotkeys", fontSize: 1, style: {
      marginTop: -4,
      marginBottom: -4
    }, keys: String(firstActionState.shortcut).split("+").map(_temp$8) }), $[6] = firstActionState.shortcut, $[7] = t32) : t32 = $[7];
    let t42;
  ...
  let t2;
  $[11] !== disabled || $[12] !== firstActionState || $[13] !== tooltipContent ? (t2 = firstActionState && /* @__PURE__ */ jsxRuntime.jsx(ui.LayerProvider, { zOffset: 200, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { disabled: !tooltipContent, content: tooltipContent, placement: "top", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Stack, { children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "data-testid": `action-${toLowerCaseNoSpaces(firstActionState.label)}`, disabled: disabled || !!firstActionState.disabled, icon: firstActionState.icon, onClick: firstActionState.onHandle, ref: setButtonElement, size: "large", text: firstActionState.label, tone: firstActionState.tone || "primary" }) }) }) }), $[11] = disabled, $[12] = firstActionState, $[13] = tooltipContent, $[14] = t2) : t2 = $[14];
  let t3;
  $[15] !== disabled || $[16] !== menuActionStates || $[17] !== showMenu ? (t3 = showMenu && menuActionStates.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(ActionMenuButton, { actionStates: menuActionStates, disabled }), $[15] = disabled, $[16] = menuActionStates, $[17] = showMenu, $[18] = t3) : t3 = $[18];
  let t4;
  $[19] !== buttonElement || $[20] !== firstActionState ? (t4 = firstActionState && firstActionState.dialog && /* @__PURE__ */ jsxRuntime.jsx(ActionStateDialog, { dialog: firstActionState.dialog, referenceElement: buttonElement }), $[19] = buttonElement, $[20] = firstActionState, $[21] = t4) : t4 = $[21];
  let t5;
  return $[22] !== t1 || $[23] !== t2 || $[24] !== t3 || $[25] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 1, children: [
    t1,
    t2,
    t3,
    t4
  ...
  let t2;
  $[2] !== t1 ? (t2 = t1.filter(_temp2$3), $[2] = t1, $[3] = t2) : t2 = $[3], t0 = t2;
  const actions = t0;
  let t3;
  ...
  const $ = reactCompilerRuntime.c(16), {
    ...
    editState,
    timelineStore
  } = useDocumentPane(), revision = sanity.useTimelineSelector(timelineStore, _temp3$2)?.id || "", disabled = (editState?.draft || editState?.published || {})._rev === revision;
  let t0, t1;
...
const DocumentPanelHeader = React.memo(React.forwardRef(function(_props, ref) {
  const {
    menuItems
  } = _props, {
    actions: allActions,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabs, tabIndex, backButton, actions: renderedActions }) });
...
const BADGE_TONES = {
  ...
  if (states.length === 0)
    return null;
  let t1;
  $[0] !== states ? (t1 = states.map(_temp$7), $[0] = states, $[1] = t1) : t1 = $[1];
  let t2;
...
function DocumentBadges() {
  const $ = reactCompilerRuntime.c(3), {
    badges,
    editState
  } = useDocumentPane(), renderDocumentBadges = _temp2$2;
  if (!editState || !badges)
    return null;
  let t0;
...
function DocumentStatusLine(t0) {
  const $ = reactCompilerRuntime.c(33), {
    ...
    editState,
    value
  } = useDocumentPane(), [status, setStatus] = React.useState(null), syncState = sanity.useSyncState(documentId, documentType), lastUpdated = value?._updatedAt;
  let t1;
  ...
  let t2;
  $[3] !== lastUpdated || $[4] !== status || $[5] !== syncState.isSyncing ? (t2 = [status, lastUpdated, syncState.isSyncing], $[3] = lastUpdated, $[4] = status, $[5] = syncState.isSyncing, $[6] = t2) : t2 = $[6], React.useEffect(t1, t2);
  let t3;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t3 = () => {
    setStatus(null);
  }, $[7] = t3) : t3 = $[7];
  let t4;
  $[8] !== documentId ? (t4 = [documentId], $[8] = documentId, $[9] = t4) : t4 = $[9], React.useLayoutEffect(t3, t4);
  let t5;
  $[10] !== syncState.isSyncing ? (t5 = () => {
    syncState.isSyncing && setStatus("syncing");
  }, $[10] = syncState.isSyncing, $[11] = t5) : t5 = $[11];
  let t6;
  if ($[12] !== lastUpdated || $[13] !== syncState.isSyncing ? (t6 = [syncState.isSyncing, lastUpdated], $[12] = lastUpdated, $[13] = syncState.isSyncing, $[14] = t6) : t6 = $[14], React.useLayoutEffect(t5, t6), status) {
    const t72 = status || void 0;
    let t82;
    return $[15] !== t72 ? (t82 = /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusPulse, { status: t72 }), $[15] = t72, $[16] = t82) : t82 = $[16], t82;
  }
  const t7 = editState?.draft, t8 = editState?.published;
  let t9;
  $[17] !== t7 || $[18] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatus, { absoluteDate: !0, draft: t7, published: t8 }), $[17] = t7, $[18] = t8, $[19] = t9) : t9 = $[19];
  const t10 = editState?.draft, t11 = editState?.published;
  let t12;
  $[20] !== t10 || $[21] !== t11 ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatusIndicator, { draft: t10, published: t11 }), $[20] = t10, $[21] = t11, $[22] = t12) : t12 = $[22];
  const t13 = editState?.draft, t14 = editState?.published;
  let t15;
  $[23] !== singleLine || $[24] !== t13 || $[25] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatus, { draft: t13, published: t14, singleLine }), $[23] = singleLine, $[24] = t13, $[25] = t14, $[26] = t15) : t15 = $[26];
  let t16;
  $[27] !== t12 || $[28] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
    t12,
    t15
  ] }), $[27] = t12, $[28] = t15, $[29] = t16) : t16 = $[29];
  let t17;
  return $[30] !== t16 || $[31] !== t9 ? (t17 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tooltip, { content: t9, placement: "top", children: t16 }), $[30] = t16, $[31] = t9, $[32] = t17) : t17 = $[32], t17;
}
...
function DocumentStatusBar(props) {
  ...
  if (createLinkMetadata && sanity.isSanityCreateLinked(createLinkMetadata) && CreateLinkedActions) {
    let t22;
    $[3] !== CreateLinkedActions || $[4] !== createLinkMetadata || $[5] !== onDocumentChange || $[6] !== title ? (t22 = /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedActions, { metadata: createLinkMetadata, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT, onDocumentChange, documentTitle: title }), $[3] = CreateLinkedActions, $[4] = createLinkMetadata, $[5] = onDocumentChange, $[6] = title, $[7] = t22) : t22 = $[7], actions = t22;
  } else if (showingRevision) {
    let t22;
    $[8] === Symbol.for("react.memo_cache_sentinel") ? (t22 = /* @__PURE__ */ jsxRuntime.jsx(HistoryStatusBarActions, {}), $[8] = t22) : t22 = $[8], actions = t22;
  } else {
    let t22;
    $[9] === Symbol.for("react.memo_cache_sentinel") ? (t22 = /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusBarActions, {}), $[9] = t22) : t22 = $[9], actions = t22;
  }
  const t2 = showingRevision ? "caution" : void 0;
  let t3;
  $[10] !== actions || $[11] !== actionsBoxRef || $[12] !== collapsed || $[13] !== shouldRender || $[14] !== showingRevision ? (t3 = shouldRender && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "stretch", gap: 1, justify: "space-between", paddingY: 2, paddingLeft: showingRevision ? 3 : 4, paddingRight: showingRevision ? 2 : 3, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", flex: 1, gap: collapsed ? 2 : 3, wrap: "wrap", paddingRight: 3, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", children: [
        showingRevision ? /* @__PURE__ */ jsxRuntime.jsx(RevisionStatusLine, {}) : /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusLine, { singleLine: !collapsed }),
  ...
  let t4;
  $[16] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { direction: "column", ref: setRootElement, sizing: "border", children: t3 }), $[16] = t3, $[17] = t4) : t4 = $[17];
  let t5;
  return $[18] !== t2 || $[19] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { tone: t2, children: t4 }), $[18] = t2, $[19] = t4, $[20] = t5) : t5 = $[20], t5;
}
...
function usePreviewUrl(value) {
  ...
  return $[4] !== resolveProductionUrl ? (t5 = subject.asObservable().pipe(operators.distinctUntilChanged(), operators.debounceTime(500), operators.switchMap((document2) => isSanityDocument(document2) ? rxjs.from(resolveProductionUrl({
    document: document2
  })) : rxjs.of(void 0)), operators.distinctUntilChanged(), operators.catchError(_temp$5)), $[4] = resolveProductionUrl, $[5] = t5) : t5 = $[5], t4 = t5, reactRx.useObservable(t4);
}
...
const DocumentPaneProvider = React.memo((props) => {
  const {
    ...
    title = null,
    views: viewsProp = []
  } = pane2, paneOptions = sanity.useUnique(options), documentIdRaw = paneOptions.id, documentId = sanity.getPublishedId(documentIdRaw), documentType = options.type, params = sanity.useUnique(paneRouter.params) || EMPTY_PARAMS$1, panePayload = sanity.useUnique(paneRouter.payload), {
    templateName,
    templateParams
    ...
    patch
  } = sanity.useDocumentOperation(documentId, documentType), editState = sanity.useEditState(documentId, documentType), {
    validation: validationRaw
  } = sanity.useValidationStatus(documentId, documentType), connectionState = sanity.useConnectionState(documentId, documentType), schemaType = schema.get(documentType), value = editState?.draft || editState?.published || initialValue.value, [isDeleting, setIsDeleting] = React.useState(!1), actions = React.useMemo(() => documentActions2({
    schemaType: documentType,
    documentId
  }), [documentActions2, documentId, documentType]), badges = React.useMemo(() => documentBadges2({
    schemaType: documentType,
    documentId
  }), [documentBadges2, documentId, documentType]), languageFilter = React.useMemo(() => languageFilterResolver({
    schemaType: documentType,
    documentId
  }), [documentId, documentType, languageFilterResolver]), validation = sanity.useUnique(validationRaw), views2 = sanity.useUnique(viewsProp), [focusPath, setFocusPath] = React.useState(() => params.path ? PathUtils.fromString(params.path) : sanity.EMPTY_ARRAY), focusPathRef = React.useRef([]), activeViewId = params.view || views2[0] && views2[0].id || null, isDeleted = React.useMemo(() => timelineReady ? !editState?.draft && !editState?.published && !isPristine : !1, [editState?.draft, editState?.published, isPristine, timelineReady]), previewUrl = usePreviewUrl(value), [presence, setPresence] = React.useState([]);
  React.useEffect(() => {
  ...
  const currentInspector = inspectors2?.find((i) => i.name === inspectorName), resolvedChangesInspector = inspectors2.find((i_0) => i_0.name === HISTORY_INSPECTOR_NAME), changesOpen = currentInspector?.name === HISTORY_INSPECTOR_NAME, {
  ...
  }, []), handleSetActiveFieldGroup = React.useCallback((path_1, groupName) => onSetFieldGroupState((prevState_1) => sanity.setAtPath(prevState_1, path_1, groupName)), []), requiredPermission = value._createdAt ? "update" : "create", liveEdit = !!schemaType?.liveEdit, docId = value._id ? value._id : "dummy-id", docPermissionsInput = React.useMemo(() => ({
    ...value,
    ...
    return !ready || revisionId !== null || hasNoPermission || updateActionDisabled || createActionDisabled || reconnecting || isLocked || isDeleting || isDeleted || isLiveEditAndDraft || isCreateLinked;
  }, [isPermissionsLoading, permissions?.granted, schemaType, isNonExistent, connectionState, editState.transactionSyncLock?.enabled, editState.draft, liveEdit, ready, revisionId, isDeleting, isDeleted, isCreateLinked]), patchRef = React.useRef(() => {
  ...
  }, [documentId, presenceStore]), updatePresenceThrottled = React.useMemo(() => throttle__default.default(updatePresence, 1e3, {
    leading: !0,
    trailing: !0
...
const DocumentPaneProviderWrapper = React.memo((props) => {
  ...
  sanity.useSource();
  let t0;
  return $[0] !== props ? (t0 = /* @__PURE__ */ jsxRuntime.jsx(DocumentPaneWithLegacyTimelineStore, { ...props }), $[0] = props, $[1] = t0) : t0 = $[1], t0;
});
...
function DocumentPaneInner(props) {
  ...
  } = sanity.useSource().document, paneRouter = usePaneRouter(), options = usePaneOptions(pane2.options, paneRouter.params), {
    documentType,
    isLoaded: isDocumentLoaded
  } = sanity.useDocumentType(options.id, options.type), DocumentLayout2 = useDocumentLayoutComponent();
  let t0, t1;
...
`, DocumentListPane = React.memo(function(props) {
  const {
    ...
    sortOrder
  }), handleQueryChange = reactRx.useObservableEvent((event$) => event$.pipe(rxjs.map((event) => event.target.value), rxjs.tap(setSearchInputValue), rxjs.debounce((value) => value === "" ? rxjs.of("") : rxjs.timer(300)), rxjs.tap(setSearchQuery))), handleClearSearch = React.useCallback(() => {
...
`, ListWrapper = styledComponents.styled(ui.Flex)`
  ...
  min-width: 244px;
`, Root$1 = styledComponents.styled(ui.Box)(({
  $visible
}) => styledComponents.css`
    opacity: 0;
    pointer-events: none;
...
const IconBox = styledComponents.styled(ui.Flex)((props) => {
  ...
  return styledComponents.css`
    border-radius: 50%;
    width: ${theme$1.avatar.sizes[1].size}px;
    height: ${theme$1.avatar.sizes[1].size}px;
  `;
  ...
  let t1;
  $[0] !== loading || $[1] !== user ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { children: loading || !user ? /* @__PURE__ */ jsxRuntime.jsx(AvatarSkeleton, { animated: !0 }) : /* @__PURE__ */ jsxRuntime.jsx(sanity.UserAvatar, { user }) }), $[0] = loading, $[1] = user, $[2] = t1) : t1 = $[2];
  let t2;
  ...
  let t3;
  $[4] !== collaborators ? (t3 = collaborators.map(_temp$1), $[4] = collaborators, $[5] = t3) : t3 = $[5];
  let t4;
...
function TimelineItem(t0) {
  ...
  const updatedTimeAgo = sanity.useRelativeTime(t5 || "", RELATIVE_TIME_OPTIONS);
  let t6, t7;
...
function TimelineError() {
  ...
  let t0;
  $[0] === Symbol.for("react.memo_cache_sentinel") ? (t0 = /* @__PURE__ */ jsxRuntime.jsx(sanity.TextWithTone, { tone: "critical", children: /* @__PURE__ */ jsxRuntime.jsx(icons.ErrorOutlineIcon, {}) }), $[0] = t0) : t0 = $[0];
  let t1;
  $[1] !== t ? (t1 = t("timeline.error.load-document-changes-title"), $[1] = t, $[2] = t1) : t1 = $[2];
  let t2;
  $[3] !== t1 ? (t2 = /* @__PURE__ */ jsxRuntime.jsx(sanity.TextWithTone, { size: 1, tone: "critical", weight: "medium", children: t1 }), $[3] = t1, $[4] = t2) : t2 = $[4];
  let t3;
  $[5] !== t ? (t3 = t("timeline.error.load-document-changes-description"), $[5] = t, $[6] = t3) : t3 = $[6];
  let t4;
  $[7] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(sanity.TextWithTone, { size: 1, tone: "critical", children: t3 }), $[7] = t3, $[8] = t4) : t4 = $[8];
  let t5;
  return $[9] !== t2 || $[10] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "flex-start", gap: 3, padding: 4, children: [
    t0,
...
function TimelineMenu({
  ...
  }, [chunks, handleLoadMore, hasMoreChunks, mode, realRevChunk, selectRev, selectSince, sinceTime, timelineError]), formatParams = {
    timestamp: {
      dateStyle: "medium",
      timeStyle: "short"
    }
...
function ChangesInspector(t0) {
  ...
  let t4;
  $[8] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, muted: !0, children: t3 }), $[8] = t3, $[9] = t4) : t4 = $[9];
  let t5;
  $[10] !== sinceTime ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(TimelineMenu, { mode: "since", chunk: sinceTime, placement: "bottom-start" }), $[10] = sinceTime, $[11] = t5) : t5 = $[11];
  let t6;
  $[12] !== structureT ? (t6 = structureT("changes.to.label"), $[12] = structureT, $[13] = t6) : t6 = $[13];
  let t7;
  $[14] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, muted: !0, children: t6 }), $[14] = t6, $[15] = t7) : t7 = $[15];
  let t8;
  $[16] !== rev ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(TimelineMenu, { chunk: rev, mode: "rev", placement: "bottom-end" }), $[16] = rev, $[17] = t8) : t8 = $[17];
  let t9;
  $[18] !== t4 || $[19] !== t5 || $[20] !== t7 || $[21] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { padding: 3, children: /* @__PURE__ */ jsxRuntime.jsxs(Grid, { paddingX: 2, paddingBottom: 2, children: [
    t4,
    t5,
    t7,
    t8
  ...
  let t10;
  $[23] !== diff || $[24] !== documentContext || $[25] !== loading || $[26] !== schemaType || $[27] !== showChanges || $[28] !== timelineError ? (t10 = showChanges && /* @__PURE__ */ jsxRuntime.jsx(Content, { diff, documentContext, error: timelineError, loading, schemaType }), $[23] = diff, $[24] = documentContext, $[25] = loading, $[26] = schemaType, $[27] = showChanges, $[28] = timelineError, $[29] = t10) : t10 = $[29];
  let t11;
  $[30] !== t10 ? (t11 = /* @__PURE__ */ jsxRuntime.jsx(Scroller$1, { "data-ui": "Scroller", ref: setScrollRef, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: 1, paddingX: 3, height: "fill", children: t10 }) }), $[30] = t10, $[31] = t11) : t11 = $[31];
  let t12;
  $[32] !== scrollRef || $[33] !== t11 ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { flex: 1, paddingX: 2, paddingY: 2, children: /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: scrollRef, children: t11 }) }), $[32] = scrollRef, $[33] = t11, $[34] = t12) : t12 = $[34];
  let t13;
  return $[35] !== t12 || $[36] !== t9 ? (t13 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", overflow: "hidden", children: [
    t9,
    t12
...
function HistorySelector({
  ...
  const {
    ...
    setTimelineRange,
    timelineStore
  } = useDocumentPane(), [scrollRef, setScrollRef] = React.useState(null), [listHeight, setListHeight] = React.useState(0), getScrollerRef = React.useCallback((el) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { "data-testid": "review-changes-pane", direction: "column", height: "fill", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { flex: 1, padding: 2, paddingTop: 0, children: timelineError ? /* @__PURE__ */ jsxRuntime.jsx(TimelineError, {}) : /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: scrollRef, children: /* @__PURE__ */ jsxRuntime.jsx(Scroller, { "data-ui": "Scroller", ref: getScrollerRef, children: listHeight && // This forces the list to unmount and remount, which is needed to reset the scroll position
...
function ChangesTabs(props) {
  const $ = reactCompilerRuntime.c(50), {
    ...
    t
  } = sanity.useTranslation(structureLocaleNamespace), isReady = params?.inspect === HISTORY_INSPECTOR_NAME, paneRouterTab = isValidTab(params?.changesInspectorTab) ? params.changesInspectorTab : TABS[0];
  let t0;
  ...
  let t5;
  $[7] !== t2 || $[8] !== t3 || $[9] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tab, { "aria-controls": "history-panel", id: "history-tab", label: t2, onClick: t3, selected: t4 }), $[7] = t2, $[8] = t3, $[9] = t4, $[10] = t5) : t5 = $[10];
  let t6;
  ...
  let t9;
  $[15] !== t6 || $[16] !== t7 || $[17] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Tab, { "aria-controls": "review-changes-panel", id: "changes-tab", label: t6, onClick: t7, selected: t8 }), $[15] = t6, $[16] = t7, $[17] = t8, $[18] = t9) : t9 = $[18];
  let t10;
  $[19] !== t5 || $[20] !== t9 ? (t10 = /* @__PURE__ */ jsxRuntime.jsxs(ui.TabList, { space: 1, flex: 1, children: [
    t5,
    t9
  ...
  let t15;
  $[28] !== props.onClose || $[29] !== t11 || $[30] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t11, icon: icons.CloseIcon, mode: "bleed", onClick: t12, tooltipProps: t14 }) }), $[28] = props.onClose, $[29] = t11, $[30] = t14, $[31] = t15) : t15 = $[31];
  let t16;
  $[32] !== t10 || $[33] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", padding: 3, gap: 2, children: [
    t10,
    t15
  ] }), $[32] = t10, $[33] = t15, $[34] = t16) : t16 = $[34];
  const t17 = paneRouterTab !== "history", t18 = paneRouterTab === "history";
  let t19;
  $[35] !== t18 ? (t19 = /* @__PURE__ */ jsxRuntime.jsx(HistorySelector, { showList: t18 }), $[35] = t18, $[36] = t19) : t19 = $[36];
  let t20;
  $[37] !== t17 || $[38] !== t19 ? (t20 = /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { "aria-labelledby": "history-tab", height: "fill", hidden: t17, id: "history-panel", children: t19 }), $[37] = t17, $[38] = t19, $[39] = t20) : t20 = $[39];
  const t21 = paneRouterTab !== "review", t22 = paneRouterTab === "review";
  let t23;
  $[40] !== t22 ? (t23 = /* @__PURE__ */ jsxRuntime.jsx(ChangesInspector, { showChanges: t22 }), $[40] = t22, $[41] = t23) : t23 = $[41];
  let t24;
  $[42] !== t21 || $[43] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsx(ui.TabPanel, { "aria-labelledby": "review-tab", hidden: t21, id: "review-panel", height: "fill", children: t23 }), $[42] = t21, $[43] = t23, $[44] = t24) : t24 = $[44];
  let t25;
  return $[45] !== t1 || $[46] !== t16 || $[47] !== t20 || $[48] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsxs(FadeInFlex, { direction: "column", padding: 0, height: "fill", "data-ready": t1, children: [
    t16,
    t20,
    t24
...
function useMenuItem(props) {
  ...
  } = sanity.useValidationStatus(documentId, documentType), validation = React.useMemo(() => validationMarkers.map((item) => ({
    level: item.level,
