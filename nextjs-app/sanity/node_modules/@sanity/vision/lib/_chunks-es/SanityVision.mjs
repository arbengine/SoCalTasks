...
import { useState, useEffect, useRef, PureComponent, createRef, Component } from "react";
...
function PerspectivePopover() {
  const $ = c(32), [open, setOpen] = useState(!1), buttonRef = useRef(null), popoverRef = useRef(null);
  let t0;
  ...
  let t4;
  $[5] !== t3 ? (t4 = /* @__PURE__ */ jsx(Text, { weight: "medium", children: t3 }), $[5] = t3, $[6] = t4) : t4 = $[6];
  let t5;
  $[7] !== t ? (t5 = t("label.new"), $[7] = t, $[8] = t5) : t5 = $[8];
  let t6;
  $[9] !== t5 ? (t6 = /* @__PURE__ */ jsx(Badge, { tone: "primary", children: t5 }), $[9] = t5, $[10] = t6) : t6 = $[10];
  let t7;
  $[11] !== t4 || $[12] !== t6 ? (t7 = /* @__PURE__ */ jsxs(Inline, { space: 2, children: [
    t4,
    t6
  ...
  let t9;
  $[16] !== t8 ? (t9 = /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(Text, { muted: !0, children: t8 }) }), $[16] = t8, $[17] = t9) : t9 = $[17];
  let t10;
  $[18] !== t ? (t10 = t("settings.perspectives.action.docs-link"), $[18] = t, $[19] = t10) : t10 = $[19];
  let t11;
  $[20] !== t10 ? (t11 = /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsx(Text, { children: /* @__PURE__ */ jsxs(PerspectivePopoverLink, { href: "https://sanity.io/docs/perspectives", target: "_blank", children: [
    t10,
    " \u2192"
  ] }) }) }), $[20] = t10, $[21] = t11) : t11 = $[21];
  let t12;
  $[22] !== t11 || $[23] !== t7 || $[24] !== t9 ? (t12 = /* @__PURE__ */ jsx(PerspectivePopoverContent, { children: /* @__PURE__ */ jsxs(Stack, { space: 4, children: [
    t7,
    t9,
    t11
  ] }) }), $[22] = t11, $[23] = t7, $[24] = t9, $[25] = t12) : t12 = $[25];
  let t13;
  $[26] !== open ? (t13 = /* @__PURE__ */ jsx(Button, { icon: HelpCircleIcon, mode: "bleed", padding: 2, tone: "primary", fontSize: 1, ref: buttonRef, onClick: handleClick, selected: open }), $[26] = open, $[27] = t13) : t13 = $[27];
  let t14;
  return $[28] !== open || $[29] !== t12 || $[30] !== t13 ? (t14 = /* @__PURE__ */ jsx(Popover, { content: t12, placement: "bottom-start", portal: !0, padding: 3, ref: popoverRef, open, children: t13 }), $[28] = open, $[29] = t12, $[30] = t13, $[31] = t14) : t14 = $[31], t14;
}
function _temp$1(o) {
  return !o;
}
